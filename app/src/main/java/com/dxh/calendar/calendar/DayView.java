...
import com.dxh.calendar.calendar.MedicineCalendarView.ShowOtherDates;
import com.dxh.calendar.calendar.format.DayFormatter;

import java.util.List;

import static com.dxh.calendar.calendar.MedicineCalendarView.showDecoratedDisabled;
import static com.dxh.calendar.calendar.MedicineCalendarView.showOtherMonths;
import static com.dxh.calendar.calendar.MedicineCalendarView.showOutOfRange;

/**
 * Display one day of a {@linkplain MedicineCalendarView}
 */
...
class DayView extends CheckedTextView {
    ...
    @ShowOtherDates
    private int showOtherDates = MedicineCalendarView.SHOW_DEFAULTS;
...
//            tempRect.set(offset, 0, radius + offset, height);
            tempRect.set(width/2-30+offset, height/2-30, width/2+30+offset, height/2+30);
            circleDrawableRect.set(circleOffset, 0, radius + circleOffset, height);
        } else {
//            tempRect.set(0, offset, width, radius +offset);
            tempRect.set(width/2-30, height/2-30+offset, width/2+30, height/2+30 + offset);
