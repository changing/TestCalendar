...
import com.dxh.calendar.calendar.format.DateFormatTitleFormatter;
import com.dxh.calendar.calendar.format.MonthArrayTitleFormatter;
import com.dxh.calendar.calendar.format.TitleFormatter;
...
public class MedicineCalendarView extends ViewGroup {
    ...
    private State state;
    public MedicineCalendarView(Context context) {
        this(context, null);
    }
    public MedicineCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray a = context.getTheme()
                .obtainStyledAttributes(attrs, R.styleable.MedicineCalendarView, 0, 0);
        try {
            int calendarModeIndex = a.getInteger(
                    R.styleable.MedicineCalendarView_mcv_calendarMode,
                    0
            );
            firstDayOfWeek = a.getInteger(
                    R.styleable.MedicineCalendarView_mcv_firstDayOfWeek,
                    -1
            );

            titleChanger.setOrientation(
                    a.getInteger(R.styleable.MedicineCalendarView_mcv_titleAnimationOrientation,
                            VERTICAL));
            ...
            final int tileSize = a.getLayoutDimension(R.styleable.MedicineCalendarView_mcv_tileSize, INVALID_TILE_DIMENSION);
            if (tileSize > INVALID_TILE_DIMENSION) {
                setTileSize(tileSize);
            }

            final int tileWidth = a.getLayoutDimension(R.styleable.MedicineCalendarView_mcv_tileWidth, INVALID_TILE_DIMENSION);
            if (tileWidth > INVALID_TILE_DIMENSION) {
                setTileWidth(tileWidth);
            }

            final int tileHeight = a.getLayoutDimension(R.styleable.MedicineCalendarView_mcv_tileHeight, INVALID_TILE_DIMENSION);
        ...
        if (isInEditMode()) {
            ...
            setWeekDayTextAppearance(adapter.getWeekDayTextAppearance());
    ...
    private void buildWeekDays() {
        for (int i = 0; i < DEFAULT_DAYS_IN_WEEK; i++) {
            ...
            WeekDayView weekDayView = new WeekDayView(getContext(),getResources().getStringArray(R.array.week)[i]);
    ...
    /**
     * Set a {@linkplain com.dxh.calendar.calendar.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.dxh.calendar.calendar.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.dxh.calendar.calendar.format.TitleFormatter)
     */
     ...
     *
     * @param orientation {@link MedicineCalendarView#VERTICAL} or {@link MedicineCalendarView#HORIZONTAL}
     */
     ...
     *
     * @return Title animation orientation {@link MedicineCalendarView#VERTICAL} or {@link MedicineCalendarView#HORIZONTAL}
     */
    ...
    protected void dispatchOnDateSelected(final CalendarDay day, final boolean selected) {
        ...
        if (l != null) {
            l.onDateSelected(MedicineCalendarView.this, day, selected);
        }
    }
    ...
    protected void dispatchOnRangeSelected(final CalendarDay firstDay, final CalendarDay lastDay) {
        ...
        if (listener != null) {
            listener.onRangeSelected(MedicineCalendarView.this, days);
        }
    }
    ...
    protected void dispatchOnMonthChanged(final CalendarDay day) {
        ...
        if (l != null) {
            l.onMonthChanged(MedicineCalendarView.this, day);
        }
    }
    ...
    public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
        ...
        event.setClassName(MedicineCalendarView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MedicineCalendarView.class.getName());
    }
    ...
    public class StateBuilder {
        ...
        public void commit() {
            MedicineCalendarView.this.commit(new State(this));
        }
    }
